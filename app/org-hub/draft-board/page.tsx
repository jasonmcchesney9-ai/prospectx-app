        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          >
            ...
            <div className="bg-white px-5 py-12 text-center">
              <Trophy size={36} style={{ color: "#DDE6EF" }} className="mx-auto mb-4" />
              <p className="text-sm font-medium" style={{ color: "#0F2942" }}>
                Draft Board is under development.
              </p>
              <p className="text-xs mt-1" style={{ color: "#8BA4BB" }}>
                Ranked prospect list with PXI scouting grades and system-fit analysis.
              </p>
              <Link
                href="/org-hub"
