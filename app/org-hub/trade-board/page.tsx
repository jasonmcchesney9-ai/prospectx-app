        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          >
            <div className="flex items-center gap-2 px-5 py-3" style={{ background: "#0F2942" }}>
              ...
              >
                Trade Targets & Priorities
              </span>
            </div>
            <div className="bg-white px-5 py-12 text-center">
              <ArrowLeftRight size={36} style={{ color: "#DDE6EF" }} className="mx-auto mb-4" />
              <p className="text-sm font-medium" style={{ color: "#0F2942" }}>
                Trade Board is under development.
              </p>
              <p className="text-xs mt-1" style={{ color: "#8BA4BB" }}>
                Track available players, targets, and trade priorities with real-time market comps.
              </p>
              <Link
                href="/org-hub"
